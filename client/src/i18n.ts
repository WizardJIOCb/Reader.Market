...
i18n
  ...
  .init({
    ...
    fallbackLng: 'en',
    defaultNS: 'common',
    ns: ['common', 'navigation', 'profile', 'notifications', 'shelves', 'search', 'messages', 'home', 'about', 'landing', 'books', 'stream', 'auth', 'oauth', 'admin', 'users', 'comments', 'reactions', 'tts', 'collections'],
