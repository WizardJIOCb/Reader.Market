server {
    ...
    # ===============================================
    # ВАЖНО: Восстановление реальных IP-адресов посетителей
    # Без этого в логах везде будет один и тот же IP Cloudflare
    # ===============================================
    ...
    location ~ \.php$ {
        ...
        # Оптимизация буферов для предотвращения 502 ошибок
