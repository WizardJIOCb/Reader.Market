...
# PostgreSQL Database Restore Script for Ubuntu/Linux with UTF-8 encoding
# Usage: ./scripts/restore-database-utf8.sh [backup_filename.sql]
...
echo "Starting database restore with UTF-8 encoding..."
echo "This may take several minutes depending on database size..."

# Execute restore with explicit UTF-8 encoding
psql \
    --host="$DB_HOST" \
    --port="$DB_PORT" \
    --username="$DB_USER" \
