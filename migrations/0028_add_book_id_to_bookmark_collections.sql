-- Migration: Add book_id to bookmark collections (proper version for deployment)
...
ADD COLUMN IF NOT EXISTS book_id VARCHAR REFERENCES books(id) ON DELETE SET NULL;

-- Create index for better performance
CREATE INDEX IF NOT EXISTS idx_bookmark_collections_book_id ON bookmark_collections(book_id);
